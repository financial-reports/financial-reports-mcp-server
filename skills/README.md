...
Agent Skills that pair with the [FinancialReports MCP server](https://github.com/financial-reports/financial-reports-mcp-server). The MCP exposes 43 tools for regulatory-filings research; these skills teach Claude how to compose those tools into the workflows analysts actually run.
